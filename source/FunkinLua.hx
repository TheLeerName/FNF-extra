...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "trailObject", function(obj:String, Length:Int = 10, Delay:Int = 3, Alpha:Float = 0.4, Diff:Float = 0.05) {
			PlayState.instance.trailObject_(obj, Length, Delay, Alpha, Diff); // hardcode yeeeeeeeee
			return 1;
		});
